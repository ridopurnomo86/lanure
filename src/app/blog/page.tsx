...
export const metadata: Metadata = {
  ...
  description: "Dapatkan tips terbaru, review produk, dan rekomendasi skincare terbaik untuk kulit sehat Anda.",
};
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-16">
      <div className="text-center space-y-4 mb-16">
        <h1 className="text-5xl md:text-6xl font-serif text-ceramide-text-dark">Blog Kami</h1>
